...
| `--ez enFullScreen`        | True/False(defualt) to hide the system navigator and control bars.                                                                                                                                                                                                                                                                                                           |
| `--ez debug`               | True/False(defualt) Output debug messages.                                                                                                                                                                                                                                                                                                                                   |
...
| `set`                | CPU counter set                                                                                                                             |         | 0: default; 1: CPU cache related; 2: CPU bandwidth related |
